  ...
  return (
    <ReviewWrapper>
      <form onSubmit={props.handleSubmit}>
        <ReviewHeadline>
          <h3>
            Have an experience with {props.name}?<br></br> Add Your Review!
          </h3>
        </ReviewHeadline>
        <Field>
        ...
        <Field>
          <RatingContainer>
            <RatingBoxTitle>Rate This Curriculum</RatingBoxTitle>
            <RatingBox>{ratingOptions}</RatingBox>
          </RatingContainer>
        </Field>
        <SubmitBtn>Create Review</SubmitBtn>
      </form>
    </ReviewWrapper>
  );
};
